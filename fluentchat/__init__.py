...
from fluentchat.blueprints.admin import admin_bp
from fluentchat.blueprints.auth import auth_bp
from fluentchat.blueprints.chat import chat_bp
from fluentchat.blueprints.oauth import oauth_bp
from fluentchat.extensions import db, login_manager, csrf, socketio, moment, oauth
from fluentchat.models import User, Message
from fluentchat.settings import config
